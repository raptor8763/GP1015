...
# Main map
gmt makecpt -T0/315/12 -Crainbow -Z > depth.cpt

gmt psbasemap -R119/123/21/26 -Jm3 -BwEsN -B1 -G0/250/250 -X-0.5 -Y5 -O -K >> $out_ps
gmt pscoast -J -B -R -O -Df -Ia -W1 -G250/250/0 -K >> $out_ps
#psxy eq.list -R -J -St0.01 -W0.01 -G255/0/0 -O -K>> report.ps
echo 121.29 22.83 | gmt psxy -R -J -Sa0.7 -W0.01 -G255/0/0 -O -K >> $out_ps

awk '{ if ($4>=3 && $4<4) print $1, $2, $3}' eq.list| gmt psxy -R -J -Sc0.01 -Cdepth.cpt -O -K>> $out_ps
awk '{ if ($4>=4 && $4<5) print $1, $2, $3}' eq.list| gmt psxy -R -J -Sc0.1 -Cdepth.cpt -O -K>> $out_ps
awk '{ if ($4>=5 && $4<6) print $1, $2, $3}' eq.list| gmt psxy -R -J -Sc0.3 -Cdepth.cpt -O -K>> $out_ps
awk '{ if ($4>=6 && $4<7) print $1, $2, $3}' eq.list| gmt psxy -R -J -Sc0.5 -Cdepth.cpt -O -K >> $out_ps
